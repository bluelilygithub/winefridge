...
<aside class="cw-mobile-cta" aria-label="Quick contact">
  <?php if ( $phone ) : ?>
    <a class="cw-mobile-cta-phone" href="tel:<?php echo esc_attr( $phone_tel ); ?>" aria-label="<?php echo esc_attr( 'Call ' . $phone ); ?>"<?php echo cw_gtm_phone_attrs( 'mobile_bar', 'gtm-phone-mobile' ); ?>>
  ...
  <?php endif; ?>
  <a class="cw-btn cw-mobile-cta-btn" href="<?php echo esc_url( home_url( '/enquire/' ) ); ?>"<?php echo cw_gtm_quote_attrs( 'mobile_bar', 'gtm-quote-mobile' ); ?>>Get a quote</a>
</aside>
